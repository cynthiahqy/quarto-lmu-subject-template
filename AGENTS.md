...
- `_extensions/lmu/` — LMU Reveal.js format (theme, logo, layout defaults) from [quarto-lmu-revealjs](https://github.com/cynthiahqy/quarto-lmu-revealjs); update with `quarto update extension cynthiahqy/quarto-lmu-revealjs`
